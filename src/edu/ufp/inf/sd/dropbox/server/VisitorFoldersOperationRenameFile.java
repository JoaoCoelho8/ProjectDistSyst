...
public class VisitorFoldersOperationRenameFile implements VisitorFoldersOperationsI, Serializable {
    ...
    public VisitorFoldersOperationRenameFile(String fileoldname, String filenewname) throws RemoteException {
    ...
    public Object visitConcreteElementUsers(DropBoxSubjectRI e) {
        ...
        return s.renameFile(fileoldname, filenewname);
    }
