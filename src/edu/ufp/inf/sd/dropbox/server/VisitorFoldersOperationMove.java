...
public class VisitorFoldersOperationMove implements VisitorFoldersOperationsI, Serializable {
    private String file;
    ...
    public VisitorFoldersOperationMove(String file, String path) throws RemoteException {
