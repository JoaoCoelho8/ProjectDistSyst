...
@Set JAVASECURITYPATH=edu/ufp/inf/sd/dropbox/securitypolicies
@Set SERVICE_NAME=%SERVICE_PREFIX%Service
@Set SERVICE_URL=rmi://%REGISTRY_HOST%:%REGISTRY_PORT%/%SERVICE_NAME_ON_REGISTRY%
...
@Set PATH=%PATH%;.;%JDK%\bin;C:\Users\PC\AppData\Local\Programs\Python\Python37-32
...
@Set AMQP_CLIENT_JAR=%JAVAPROJ%/%JAVAPROJ_DIST_LIB%/amqp-client-5.5.1.jar
@Set SFL4J_API_JAR=%JAVAPROJ%/%JAVAPROJ_DIST_LIB%/slf4j-api-1.7.25.jar
@Set SFL4J_SIMPLE_JAR=%JAVAPROJ%/%JAVAPROJ_DIST_LIB%/slf4j-simple-1.7.25.jar

@REM set CLASSPATH=.;%JAVAPROG_CLASSES_FOLDER%
@set CLASSPATH=.;%JAVAPROJ_DIST_FOLDER%/%JAVAPROJ_JAR_FILE%;%AMQP_CLIENT_JAR%;%SFL4J_API_JAR%;%SFL4J_SIMPLE_JAR%
